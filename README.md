...
La couche **Météo** de la carte (`FR-043`) n’a pas d’interrupteur : les nuages font partie de la carte, lue autour du pilote. Ses deux fournisseurs sont publics et **sans clé**, donc branchés par défaut : `WEATHER_PROVIDER=open-meteo` pour les prévisions (nuages, probabilité de pluie) et `RADAR_PROVIDER=rainviewer` pour les images radar.
